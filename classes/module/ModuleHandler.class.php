...
class ModuleHandler extends Handler {
	...
	public static function daolErrorLog($errnumber, $errormassage, $errorfile, $errorline, $errorcontext) {
		...
		if(count($backtrace) > 1 && $backtrace[1]['function'] === 'daolErrorLog' && !$backtrace[1]['class']) {
