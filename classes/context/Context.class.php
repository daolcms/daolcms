 ...
 * It has dual method structure, easy-to use methods which can be called as self::methodname(),and methods called with
 * static object.
 *
...
class Context {
	 ...
	 * @param bool   $autoEncode If true, url encode automatically, detailed. Use this option, $encode value should be
	 *                           true
	 * @return string URL
	 */
