...
class DBSqlite3_pdo extends DB {
	 ...
	 **/
	function begin(){
		if(!$this->is_connected || $this->transaction_started){
			return;
		}
...
DBSqlite3_pdo::$isSupported = function_exists('PDO');

/* End of file DBSqlite3_pdo.class.php */
/* Location: ./classes/db/DBSqlite3_pdo.class.php */
