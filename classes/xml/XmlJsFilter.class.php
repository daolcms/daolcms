 ...
 * @code
 * <pre>{
 * <filter name="name of javascript funcion" act="action name" confirm_msg_code="message string to be prompted when
 * submitting the form" >
 *  <form> <-- code to validate data in the form
 *    <node target="name" required="true" minlength="1" maxlength="5" filter="email,userid,alpha,number"
 *    equalto="target" />
 *  </form>
 * <parameter> "- A form of key = val combination of items to js array return, act required
 *    <param name="key" target="target" />
 *  </parameter>
 * <response callback_func="specifying the name of js function to callback" > "- Result to get by sending ajax to the
 * server
 ...
 *      2) userid : validate the confirmance of the value against the format of user id. (combination of
 *      number[0-9],alphabet(lower case) and '_', underscore starting with an alphatic character)
