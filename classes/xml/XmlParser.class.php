 ...
 * For example, if 'xml:lang='ko, en, ch, jp..' is given in a xml file, only ko will be left ignoring all other
 * language
 * attributes when kor is only supported language. It seems to work fine now but we did not scrutinze any potential
 * side effects,
 * }</pre>
 *
 * @author  NAVER (developers@xpressengine.com)
...
class XmlParser {
	 ...
	 * @return array Returns a data object containing data extracted from a xml file or NULL if a specified file does
	 *               not exist
	 */
