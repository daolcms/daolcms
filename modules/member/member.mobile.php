<?php
require_once(_DAOL_PATH_ . 'modules/member/member.view.php');

class memberMobile extends memberView {
	/**
	 * Support method are
	 * dispMemberInfo, dispMemberSignUpForm, dispMemberFindAccount, dispMemberGetTempPassword, dispMemberModifyInfo,
