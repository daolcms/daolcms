...
class autoinstallAdminView extends autoinstall {
	 ...
	 *
	 * $targets:
	 * array('category_srl', 'package_srl', 'item_screenshot_url', 'package_voted', 'package_voter',
	 * 'package_description', 'package_downloaded', 'item_regdate', 'title', 'item_version', 'package_star',
	 * 'depfrom');
	 *
	 * returns:
	 * stdClass Object
