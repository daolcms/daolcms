...
require_once(_DAOL_PATH_ . 'modules/page/page.view.php');
...
class pageMobile extends pageView {
	...
	function _getWidgetContent(){
		...
		if($this->module_info->mcontent){
			$cache_file = sprintf("%sfiles/cache/page/%d.%s.m.cache.php", _DAOL_PATH_, $this->module_info->module_srl, Context::getLangType());
