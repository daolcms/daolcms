...
class emoticon extends EditorHandler {
	...
	/**
	 * @brief Likely to be recursively emoticons will search all the files to a subdirectory. 8000 gaekkajineun ran
	 *        tests whether the stack and raise beef pro-overs and Unsure. (06/09/2007, Benny)
	 **/
